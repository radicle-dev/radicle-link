...
`schema.json` contains a 
https://json-schema.org/draft/2020-12/json-schema-core.html[draft 2020-12] JSON
schema whilst `manifest.toml` is a TOML file with the following contents:
