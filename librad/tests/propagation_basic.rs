...
async fn fetches_on_gossip_notify() {
    ...
    testnet::run_on_testnet(peers, NUM_PEERS, async move |mut apis| {
        ...
        let commit_id = {
            ...
            let mut origin = repo
                .remote("origin", &LocalUrl::from_urn(radicle.urn(), peer1.peer_id().clone()).to_string())
                .unwrap();
...
#[tokio::test]
async fn fetches_on_gossip_notify_foo() {
    logging::init();
...
#[tokio::test]
async fn fetches_on_gossip_notify_bar() {
    logging::init();
...
#[tokio::test]
async fn fetches_on_gossip_notify_baz() {
    logging::init();
...
#[tokio::test]
async fn fetches_on_gossip_notify_quux() {
    logging::init();
...
#[tokio::test]
async fn fetches_on_gossip_notify_1() {
    logging::init();
...
#[tokio::test]
async fn fetches_on_gossip_notify_2() {
    logging::init();
...
#[tokio::test]
async fn fetches_on_gossip_notify_3() {
    logging::init();
...
#[tokio::test]
async fn fetches_on_gossip_notify_4() {
    logging::init();
...
#[tokio::test]
async fn fetches_on_gossip_notify_5() {
    logging::init();
