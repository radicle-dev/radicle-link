...
use librad::net::protocol::membership::{PartialView, Transition};
use link_crypto::PeerId;
use link_crypto_test::gen::{gen_peer_id, gen_peers};

use crate::gen::protocol::{blank_peer_info, gen_partial_view};
