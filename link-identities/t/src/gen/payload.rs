...
use link_canonical_test::gen::gen_cstring;
use link_crypto_test::gen::gen_public_key;
use link_identities::{
    delegation,
    payload::{
        HasNamespace,
...
use crate::gen::urn::gen_oid;

static UPSTREAM_USER_NAMESPACE: Lazy<Url> =
    Lazy::new(|| Url::parse("https://radicle.xyz/upstream/user/v1").unwrap());
